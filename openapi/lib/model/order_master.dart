...
part 'order_master.g.dart';

abstract class OrderMaster implements Built<OrderMaster, OrderMasterBuilder> {
    ...
    String get notes;
        ...
        @nullable
    @BuiltValueField(wireName: r'offerLines')
    BuiltList<OfferLine> get offerLines;
    ...
    factory OrderMaster([updates(OrderMasterBuilder b)]) = _$OrderMaster;
    static Serializer<OrderMaster> get serializer => _$orderMasterSerializer;
