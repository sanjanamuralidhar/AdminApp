...
part of 'page_of_store.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<PageOfStore> _$pageOfStoreSerializer = new _$PageOfStoreSerializer();

class _$PageOfStoreSerializer implements StructuredSerializer<PageOfStore> {
  @override
  final Iterable<Type> types = const [PageOfStore, _$PageOfStore];
  @override
  final String wireName = 'PageOfStore';

  @override
  Iterable<Object> serialize(Serializers serializers, PageOfStore object,
  ...
  @override
  PageOfStore deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PageOfStoreBuilder();
...
class _$PageOfStore extends PageOfStore {
  @override
  final BuiltList<Store> content;
  @override
  final bool empty;
  @override
  final bool first;
  ...
  factory _$PageOfStore([void Function(PageOfStoreBuilder) updates]) =>
      (new PageOfStoreBuilder()..update(updates)).build();
  ...
  @override
  PageOfStore rebuild(void Function(PageOfStoreBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PageOfStoreBuilder toBuilder() => new PageOfStoreBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PageOfStore &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PageOfStore')
          ..add('content', content)
          ..add('empty', empty)
          ..add('first', first)
          ..add('last', last)
...
class PageOfStoreBuilder implements Builder<PageOfStore, PageOfStoreBuilder> {
  _$PageOfStore _$v;

  ListBuilder<Store> _content;
  ListBuilder<Store> get content =>
      _$this._content ??= new ListBuilder<Store>();
  set content(ListBuilder<Store> content) => _$this._content = content;
  ...
  @override
  void replace(PageOfStore other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$PageOfStore;
  }

  @override
  void update(void Function(PageOfStoreBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$PageOfStore build() {
    _$PageOfStore _$result;
    try {
      _$result = _$v ??
          new _$PageOfStore._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PageOfStore', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
