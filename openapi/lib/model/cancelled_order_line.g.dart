...
part of 'cancelled_order_line.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<CancelledOrderLine> _$cancelledOrderLineSerializer =
    new _$CancelledOrderLineSerializer();

class _$CancelledOrderLineSerializer
    implements StructuredSerializer<CancelledOrderLine> {
  @override
  final Iterable<Type> types = const [CancelledOrderLine, _$CancelledOrderLine];
  @override
  final String wireName = 'CancelledOrderLine';

  @override
  Iterable<Object> serialize(Serializers serializers, CancelledOrderLine object,
  ...
  @override
  CancelledOrderLine deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CancelledOrderLineBuilder();
...
class _$CancelledOrderLine extends CancelledOrderLine {
  @override
  ...
  factory _$CancelledOrderLine(
          [void Function(CancelledOrderLineBuilder) updates]) =>
      (new CancelledOrderLineBuilder()..update(updates)).build();

  _$CancelledOrderLine._(
      {this.ammount,
  ...
  @override
  CancelledOrderLine rebuild(
          void Function(CancelledOrderLineBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CancelledOrderLineBuilder toBuilder() =>
      new CancelledOrderLineBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CancelledOrderLine &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CancelledOrderLine')
          ..add('ammount', ammount)
...
class CancelledOrderLineBuilder
    implements Builder<CancelledOrderLine, CancelledOrderLineBuilder> {
  _$CancelledOrderLine _$v;
  ...
  CancelledOrderLineBuilder();

  CancelledOrderLineBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(CancelledOrderLine other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CancelledOrderLine;
  }

  @override
  void update(void Function(CancelledOrderLineBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$CancelledOrderLine build() {
    _$CancelledOrderLine _$result;
    try {
      _$result = _$v ??
          new _$CancelledOrderLine._(
              ammount: ammount,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'CancelledOrderLine', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
