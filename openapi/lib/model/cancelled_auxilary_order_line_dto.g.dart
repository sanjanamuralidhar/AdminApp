...
part of 'cancelled_auxilary_order_line_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<CancelledAuxilaryOrderLineDTO>
    _$cancelledAuxilaryOrderLineDTOSerializer =
    new _$CancelledAuxilaryOrderLineDTOSerializer();

class _$CancelledAuxilaryOrderLineDTOSerializer
    implements StructuredSerializer<CancelledAuxilaryOrderLineDTO> {
  @override
  final Iterable<Type> types = const [
    CancelledAuxilaryOrderLineDTO,
    _$CancelledAuxilaryOrderLineDTO
  ];
  @override
  final String wireName = 'CancelledAuxilaryOrderLineDTO';

  @override
  Iterable<Object> serialize(
      Serializers serializers, CancelledAuxilaryOrderLineDTO object,
  ...
  @override
  CancelledAuxilaryOrderLineDTO deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CancelledAuxilaryOrderLineDTOBuilder();
...
class _$CancelledAuxilaryOrderLineDTO extends CancelledAuxilaryOrderLineDTO {
  @override
  ...
  factory _$CancelledAuxilaryOrderLineDTO(
          [void Function(CancelledAuxilaryOrderLineDTOBuilder) updates]) =>
      (new CancelledAuxilaryOrderLineDTOBuilder()..update(updates)).build();

  _$CancelledAuxilaryOrderLineDTO._(
      {this.ammount,
  ...
  @override
  CancelledAuxilaryOrderLineDTO rebuild(
          void Function(CancelledAuxilaryOrderLineDTOBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CancelledAuxilaryOrderLineDTOBuilder toBuilder() =>
      new CancelledAuxilaryOrderLineDTOBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CancelledAuxilaryOrderLineDTO &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CancelledAuxilaryOrderLineDTO')
          ..add('ammount', ammount)
...
class CancelledAuxilaryOrderLineDTOBuilder
    implements
        Builder<CancelledAuxilaryOrderLineDTO,
            CancelledAuxilaryOrderLineDTOBuilder> {
  _$CancelledAuxilaryOrderLineDTO _$v;
  ...
  CancelledAuxilaryOrderLineDTOBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(CancelledAuxilaryOrderLineDTO other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CancelledAuxilaryOrderLineDTO;
  }

  @override
  void update(void Function(CancelledAuxilaryOrderLineDTOBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$CancelledAuxilaryOrderLineDTO build() {
    final _$result = _$v ??
        new _$CancelledAuxilaryOrderLineDTO._(
            ammount: ammount,
