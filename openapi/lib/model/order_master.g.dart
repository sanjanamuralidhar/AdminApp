...
part of 'order_master.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<OrderMaster> _$orderMasterSerializer = new _$OrderMasterSerializer();

class _$OrderMasterSerializer implements StructuredSerializer<OrderMaster> {
  @override
  final Iterable<Type> types = const [OrderMaster, _$OrderMaster];
  @override
  final String wireName = 'OrderMaster';

  @override
  Iterable<Object> serialize(Serializers serializers, OrderMaster object,
    ...
    if (object.offerLines != null) {
      result
        ..add('offerLines')
        ..add(serializers.serialize(object.offerLines,
            specifiedType:
  ...
  @override
  OrderMaster deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new OrderMasterBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'notes':
          ...
          break;
        case 'offerLines':
          result.offerLines.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(OfferLine)]))
              as BuiltList<Object>);
          break;
...
class _$OrderMaster extends OrderMaster {
  @override
  ...
  final String notes;
  @override
  final BuiltList<OfferLine> offerLines;
  @override
  ...
  factory _$OrderMaster([void Function(OrderMasterBuilder) updates]) =>
      (new OrderMasterBuilder()..update(updates)).build();
  ...
  @override
  OrderMaster rebuild(void Function(OrderMasterBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OrderMasterBuilder toBuilder() => new OrderMasterBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OrderMaster &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, addressType.hashCode), allergyNote.hashCode), alternatePhone.hashCode), cancellationRef.hashCode), city.hashCode), customerId.hashCode), customerName.hashCode), customerOrder.hashCode), deliveryCharge.hashCode), email.hashCode), expectedDelivery.hashCode), houseNoOrBuildingName.hashCode), id.hashCode), landmark.hashCode), loyaltyPoint.hashCode), methodOfOrder.hashCode), nextTaskId.hashCode), notes.hashCode), offerLines.hashCode), orderAcceptedAt.hashCode), orderDiscountAmount.hashCode), orderFromCustomer.hashCode), orderLines.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrderMaster')
...
class OrderMasterBuilder implements Builder<OrderMaster, OrderMasterBuilder> {
  _$OrderMaster _$v;
  ...
  ListBuilder<OfferLine> _offerLines;
  ListBuilder<OfferLine> get offerLines =>
      _$this._offerLines ??= new ListBuilder<OfferLine>();
  set offerLines(ListBuilder<OfferLine> offerLines) =>
      _$this._offerLines = offerLines;
  ...
  OrderMasterBuilder get _$this {
    if (_$v != null) {
      ...
      _notes = _$v.notes;
      _offerLines = _$v.offerLines?.toBuilder();
  ...
  @override
  void replace(OrderMaster other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$OrderMaster;
  }

  @override
  void update(void Function(OrderMasterBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$OrderMaster build() {
    _$OrderMaster _$result;
    try {
      _$result = _$v ??
          new _$OrderMaster._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'OrderMaster', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
