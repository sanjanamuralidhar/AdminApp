...
part of 'page_of_about.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<PageOfAbout> _$pageOfAboutSerializer = new _$PageOfAboutSerializer();

class _$PageOfAboutSerializer implements StructuredSerializer<PageOfAbout> {
  @override
  final Iterable<Type> types = const [PageOfAbout, _$PageOfAbout];
  @override
  final String wireName = 'PageOfAbout';

  @override
  Iterable<Object> serialize(Serializers serializers, PageOfAbout object,
  ...
  @override
  PageOfAbout deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PageOfAboutBuilder();
...
class _$PageOfAbout extends PageOfAbout {
  @override
  final BuiltList<About> content;
  @override
  final bool empty;
  @override
  final bool first;
  ...
  factory _$PageOfAbout([void Function(PageOfAboutBuilder) updates]) =>
      (new PageOfAboutBuilder()..update(updates)).build();
  ...
  @override
  PageOfAbout rebuild(void Function(PageOfAboutBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PageOfAboutBuilder toBuilder() => new PageOfAboutBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PageOfAbout &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PageOfAbout')
          ..add('content', content)
          ..add('empty', empty)
          ..add('first', first)
          ..add('last', last)
...
class PageOfAboutBuilder implements Builder<PageOfAbout, PageOfAboutBuilder> {
  _$PageOfAbout _$v;

  ListBuilder<About> _content;
  ListBuilder<About> get content =>
      _$this._content ??= new ListBuilder<About>();
  set content(ListBuilder<About> content) => _$this._content = content;
  ...
  @override
  void replace(PageOfAbout other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$PageOfAbout;
  }

  @override
  void update(void Function(PageOfAboutBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$PageOfAbout build() {
    _$PageOfAbout _$result;
    try {
      _$result = _$v ??
          new _$PageOfAbout._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PageOfAbout', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
